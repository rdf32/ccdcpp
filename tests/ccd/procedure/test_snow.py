...
from ccd.procedures import permanent_snow_procedure
...
results, mask = permanent_snow_procedure(
    dates,
    spectra,
    fitter_fn,
    qas,
...
print("Saved snow_reference.csv")
print("Saved snow_mask_reference.csv")
